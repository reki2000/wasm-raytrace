...
#define SK 0.062f
#ifndef CAM_TARGET_X
// Dinosaurs face and advance along +X; lead the orbit target toward the head
// instead of the body origin so the camera does not drift back toward the tail.
#define CAM_TARGET_X 0.75f
#endif
#ifndef CAM_TARGET_Y
